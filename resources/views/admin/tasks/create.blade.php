                              ...
                              <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" required name="description"
                                                   placeholder="Descreva a tarefa." class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Processo</label>
                                        <div class="col-sm-10">
                                            <select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="process_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="user_id" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="frequency">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                              <select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="method">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group"><label class="col-sm-2 control-label">Cliente</label>
                                        <div class="col-sm-10"><select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="client_id">
                                    ...
                                    <div class="form-group"><label class="col-sm-2 control-label">Fornecedor</label>
                                        <div class="col-sm-10"><select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="vendor_id">
                                                @foreach($departments as $department)
                                                    <option value="{{$department->id}}">{{$department->name}}</option>
                                                @endforeach
                                            </select></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="severity">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="urgency">
                                                <option value="1">1 (baixissima)</option>
                                                <option value="2">2 (baixa)</option>
                                                <option value="3">3 (moderada)</option>
                                                <option value="4">4 (alta)</option>
                                  ...
                                  <div class="col-sm-10">
                                      <select class="selectpicker" data-live-search="true" show-tick show-menu-arrow data-width="100%"  name="trend">
                                          <option value="1">1 (baixissima)</option>
                                          <option value="2">2 (baixa)</option>
                                          <option value="3">3 (moderada)</option>
                                          <option value="4">4 (alta)</option>
