...
*/
          ...
          $departmentUser = $user->department_id ? $user->department->id : null;

          return view('admin.processes.index',
          compact('departments', 'frequencies', 'isAdmin', 'departmentUser'));
...
*/
    ...
    public function create()
    {
        ...
        return view('admin.processes.create', compact('user', 'isAdmin', 'departmentUser'))
