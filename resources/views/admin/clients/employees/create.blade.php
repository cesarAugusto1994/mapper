                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" class="form-horizontal" action="{{route('client_employee_store', $company->uuid)}}">
                            ...
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-10">
                                <input type="text" value="{{ old('name') }}" name="name" class="form-control" autofocus required/>
                            ...
                            <div class="form-group {{ $errors->has('cpf') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-10">
                                <input type="text" value="{{ old('cpf') }}" name="cpf" class="form-control inputCpf" required/>
                            ...
                            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-10">
                                <input type="text" value="{{ old('phone') }}" name="phone" class="form-control inputPhone"/>
